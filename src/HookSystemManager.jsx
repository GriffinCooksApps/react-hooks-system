...
var ReactHookFactoryManager = /** @class */ (function () {
    function ReactHookFactoryManager() {
        var _this = this;
        this.status = Constants_1.HookSystemStatus.dormant;
        this.Provider = function (_a) {
            ...
            var _e = React.useReducer(reducer, null), dstate = _e[0], dispatch = _e[1];
            ...
            var offSpring = state === null || !fonts ? (<View />) : (<ErrorHandler>{children}</ErrorHandler>);
            if (state !== null) {
            ...
            //
            //
            return (<HookContext.Provider value={{ state: state, dispatch: dispatch }}>
        {offSpring}
    ...
    return ReactHookFactoryManager;
}());
